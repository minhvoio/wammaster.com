  ...
  return (
    <>
      <div className="bg-bgPrimary flex-1">
        <div className="mx-auto flex w-4/5 py-24">
          <div className="flex-col space-y-6">
            <h1 className="text-5xl font-bold">Privacy Policy</h1>
            <div className="flex-col space-y-4">
              <p className="text-xl">
                WAM Master is committed to providing quality services to you and
            ...
            <h2 className="text-2xl font-bold">Sensitive Information</h2>
            <div className="flex-col space-y-4">
              <p className="text-xl">
            ...
            <div className="flex-col space-y-4">
              ...
              <p className="text-xl">
                WAM Master will not charge any fee for your access request, but
